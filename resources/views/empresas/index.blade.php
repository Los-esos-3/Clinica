<x-app-layout>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('empresas.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="pais" name="pais" class="form-control border-gray-400 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm @error('pais') is-invalid @enderror" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control border-gray-400 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm @error('horario') is-invalid @enderror" 
                                            id="horario" 
                                            name="horario" 
                                            required>
                                        <option value="">Seleccione un horario</option>
                                        <option value="Lunes a Viernes de 9:00 AM a 6:00 PM">Lunes a Viernes de 9:00 AM a 6:00 PM</option>
                                        <option value="Lunes a Sábado de 9:00 AM a 6:00 PM">Lunes a Sábado de 9:00 AM a 6:00 PM</option>
                                        <option value="Lunes a Domingo de 9:00 AM a 6:00 PM">Lunes a Domingo de 9:00 AM a 6:00 PM</option>
                                        <option value="Lunes a Viernes de 8:00 AM a 5:00 PM">Lunes a Viernes de 8:00 AM a 5:00 PM</option>
                                        <option value="Lunes a Sábado de 8:00 AM a 5:00 PM">Lunes a Sábado de 8:00 AM a 5:00 PM</option>
                                        <option value="Lunes a Domingo de 8:00 AM a 5:00 PM">Lunes a Domingo de 8:00 AM a 5:00 PM</option>
                                        <option value="Lunes a Viernes de 10:00 AM a 7:00 PM">Lunes a Viernes de 10:00 AM a 7:00 PM</option>
                                        <option value="Lunes a Sábado de 10:00 AM a 7:00 PM">Lunes a Sábado de 10:00 AM a 7:00 PM</option>
                                        <option value="Lunes a Domingo de 10:00 AM a 7:00 PM">Lunes a Domingo de 10:00 AM a 7:00 PM</option>
    ...
    <style>
        .form-control {
            border: 1px solid #d1d5db !important; /* Gris más suave */
            transition: all 0.3s ease;
        }
        
        .form-control:focus {
            border-color: #2e75c7 !important; /* Indigo/azul */
            box-shadow: 0 0 0 2px rgba(86, 152, 223, 0.2) !important; /* Sombra suave azul */
            outline: none;
        }
