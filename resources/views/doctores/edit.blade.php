                    ...
                    <form action="{{ isset($doctor) ? route('doctores.update', $doctor->id) : route('doctores.store') }}"
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Especialidad Médica <label class="pl-5 text-red-500">*Obligatorio*</label></label>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Universidad <label class="pl-5 text-gray-400">*Opcional*</label></label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Título <label class="pl-5 text-gray-400">*Opcional*</label></label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Año de Graduación <label class="pl-5 text-gray-400">*Opcional*</label></label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Años de Experiencia <label class="pl-5 text-gray-400">*Opcional*</label></label>
                                ...
                                <div class="md:col-span-2">
                                    <label class="block text-sm font-medium text-gray-700">Hospitales Previos <label class="pl-5 text-gray-400">*Opcional*</label></label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Área/Departamento <label class="pl-5 text-gray-400">*Opcional*</label></label>
