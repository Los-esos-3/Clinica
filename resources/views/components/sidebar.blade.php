    ...
    <div class="sidebar-container">
        ...
        <div id="sidebar" class="sidebar closed">
            ...
            @if (Auth::user()->hasAnyRole(['Admin', 'Root']))
                <div class="overlay fixed inset-0 bg-opacity-70 z-[9999] flex items-center justify-center hidden"
                    id="overlay">
                    <div
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-500 text-blue-700 p-3 rounded-md text-sm italic">
                            <p><i class="fas fa-info-circle mr-2"></i> Este paso es importante para personalizar tu
                                sistema y prepararlo para tu consultorio.</p>
                        </div>
                    </div>
                </div>
            @endif
            ...
            <ul
                    ...
                    <li class="relative">
                        <a href="{{ route('empresas.index') }}" id="empresa-link"
                            ...
                            <svg id="flecha-empresa"
                                ...
                                fill="none" stroke="currentColor" width="32" height="32" viewBox="0 0 22 22"
                                xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M7 8l-4 4m0 0l4 4m-4-4h14"></path>
                            </svg>
                        </a>
                    </li>
                @endif
                ...
                @if (Auth::user()->hasRole('Root'))
                    <li><a href="{{ route('roles.index') }}"><i
                                class="fa-solid fa-users-gear"></i><span>Roles</span></a>
                    </li>
                @endif

                <li><a href="{{ route('profile.show') }}"><i class="fas fa-user-circle"></i><span>Perfil</span></a>
                </li>
            </ul>
