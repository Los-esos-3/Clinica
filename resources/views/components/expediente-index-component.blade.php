            ...
            <table class="min-w-full">  
                <thead class="bg-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">Familiar a Cargo</th>
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">Número de Familiar</th>
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">Próxima cita</th>
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">Hora de la cita</th>
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">Fecha de Registro</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($expedientes as $expediente)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $expediente->hora_proxima_cita}}</td>
