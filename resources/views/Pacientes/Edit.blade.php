                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('Pacientes.update', $paciente->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="flex">
                            <div class="w-1/4">
                                ...
                                <div id="drop-area" class="border-2 border-dashed border-gray-300 p-4 rounded-lg text-center h-auto cursor-pointer">
                                    ...
                                    <div id="imagePreview" class="mt-2">
                                        <img id="preview" src="{{ asset('storage/' . $paciente->foto_perfil) }}" class="w-32 h-32 object-cover rounded-lg shadow-md">
                                    </div>
                                    <p id="drop-text" class="hidden">Arrastra y suelta una imagen aquí o haz clic para seleccionar</p>
                            
                                    <!-- Input para seleccionar la imagen -->
                                    <input value="{{old('$paciente->foto_perfil')}}" type="file" name="foto_perfil" id="foto_perfil" accept="image/*" onchange="previewImage(this)" class="hidden">
                                </div>
                            ...
                            <div class="w-3/4 pl-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="nombre" id="nombre" required value="Antonio Juarez"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="telefono" id="telefono" value="8623452234"
                                        class="block w-full p-2 mt-1 border border-gray-400 rounded-md" />
                                </div>
                                ...
                                <div class="mb-4">
                                    <label for="fecha_nacimiento" class="block text-sm font-medium text-gray-700">Fecha
                                        de Nacimiento</label>
                                    <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" value="1989-04-23"
                                        class="block w-full p-2 mt-1 border border-gray-400 rounded-md" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="edad" id="edad" value="{{ \Carbon\Carbon::parse('1989-04-23')->age }}"
