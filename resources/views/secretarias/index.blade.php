                        ...
                        <div class="secretary-content">
                            ...
                            <div id="infoAdicional{{ $secretaria->id }}" class="info-adicional">
                                ...
                                <div class="info-section">
                                    ...
                                    <p><span class="font-medium">Departamento:</span> {!! $secretaria->departamento ?: '<span class="text-red-500">No proporcionado</span>' !!}</p>
                                    <p><span class="font-medium">Experiencia Laboral:</span> {!! $secretaria->experiencia_laboral ?: '<span class="text-red-500">No proporcionado</span>' !!}</p>
                                ...
                                <div class="flex justify-end space-x-2 mt-4">
                                    ...
                                    <button onclick="showDeleteModal('{{ $secretaria->nombre_completo }}', '{{ route('secretarias.destroy', $secretaria->id) }}')" 
