                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ isset($secretaria) ? route('secretarias.update', $secretaria->id) : route('secretarias.store') }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="domicilio" rows="2"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('domicilio', $secretaria->domicilio ?? '') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Año de Contratación <label class="pl-5 text-red-500">*Obligatorio*</label></label>
                                    <input type="number" name="año_contratacion"
                                        value="{{ old('año_contratacion', $secretaria->año_contratacion ?? '') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Años de Experiencia <label class="pl-5 text-red-500">*Obligatorio*</label></label>
                                    <input type="number" name="años_experiencia"
                                        value="{{ old('años_experiencia', $secretaria->años_experiencia ?? '') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                                </div>
