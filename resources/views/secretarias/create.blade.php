            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h2 class="text-2xl font-bold mb-4">
                        {{ isset($secretaria) ? 'Editar Secretaria' : 'Registrar Nueva Secretaria' }}</h2>
                    ...
                    <form
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="nombre_completo"
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('nombre_completo') border-red-500 @enderror"
                                        required>
                                ...
                                <div>
                                    ...
                                    <select name="genero"
                                        ...
                                        <option value="Masculino"
                                            {{ old('genero', $secretaria->genero ?? '') == 'Masculino' ? 'selected' : '' }}>
                                            Masculino</option>
                                        <option value="Femenino"
                                            {{ old('genero', $secretaria->genero ?? '') == 'Femenino' ? 'selected' : '' }}>
                                            Femenino</option>
                                        <option value="Otro"
                                            {{ old('genero', $secretaria->genero ?? '') == 'Otro' ? 'selected' : '' }}>
                                            Otro</option>
                                    </select>
                                    @error('genero')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Foto de Perfil <label
                                            class="pl-5 text-red-500">*Obligatorio*</label></label>
                                    <div id="drop-area"
                                        class="border-2 border-dashed @error('foto_perfil') border-red-500 @else border-gray-300 @enderror p-4 rounded-lg text-center">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="domicilio" rows="2"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('domicilio') border-red-500 @enderror">{{ old('domicilio', $secretaria->domicilio ?? '') }}</textarea>
                                    @error('domicilio')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Teléfono de Emergencia
                                        <label class="pl-5 text-gray-400">*Opcional*</label></label>
                                    <input type="tel" name="contacto_emergencia_telefono"
                                        value="{{ old('contacto_emergencia_telefono', $secretaria->contacto_emergencia_telefono ?? '') }}"
