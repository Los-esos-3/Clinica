        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('Doctor.Secretaria.Asignar') }}">
                        @csrf
                        <div class="mb-4">
                            <label for="secretaria_id" class="block text-sm font-medium text-gray-700">
                                Seleccionar Secretaria
                            </label>
                            <select name="secretaria_id" id="secretaria_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        ...
                        <ul>
                            @foreach ($secretariasAsignadas as $secretaria)
                                <li class="flex items-center justify-between p-4 border-b">
                                    ...
                                    <form method="POST" action="{{ route('Doctor.Secretaria.Desasignar', $secretaria->id) }}">
                                        @csrf
                                        @method('DELETE')
